...
fn <- "../../benchmarking/scenarios/lung/20pc/1000GenomesFilt_cellSNPVireo/vireo/donor_ids.tsv"
...
ggplot(df, aes(x = cluster, y = num.de)) + 
  ...
  ggtitle("Lung, 20% doublets") + 
  theme_bw() + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1))

ggsave("../../plots/supp_downstream/downstream_doublets_elbow_lung_20pc.pdf", width = 9, height = 4.5)
ggsave("../../plots/supp_downstream/downstream_doublets_elbow_lung_20pc.png", width = 9, height = 4.5)
