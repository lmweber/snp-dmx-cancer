...
fn <- "../../benchmarking/scenarios/HGSOC/30pc/bulkBcftools_cellSNPVireo/vireo/donor_ids.tsv"
...
ggplot(df, aes(x = cluster, y = num.de)) + 
  ...
  ggtitle("HGSOC, 30% doublets") + 
  theme_bw()

ggsave("../../plots/supp_downstream/downstream_doublets_elbow_HGSOC_30pc.pdf", width = 7, height = 4.5)
ggsave("../../plots/supp_downstream/downstream_doublets_elbow_HGSOC_30pc.png", width = 7, height = 4.5)
