...
ggsave("../../../plots/supp_debris/precision_recall_lung_doublets30pc_debris40pc.pdf", width = 6, height = 3.5)
ggsave("../../../plots/supp_debris/precision_recall_lung_doublets30pc_debris40pc.png", width = 6, height = 3.5)
