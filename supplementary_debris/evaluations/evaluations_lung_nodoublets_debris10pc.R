...
# lung dataset, no doublets / 10pc debris simulation
...
# barcodes
fn_barcodes_merged <- "../../../supplementary_debris/scenarios/lung/nodoublets/barcodes_merged_lung_nodoublets_debris10pc.tsv"
...
for (i in 1:length(scenario_names)) {
  ...
  # Vireo scenarios
  if (i == 1) {
    fn <- paste0("../../../supplementary_debris/scenarios/lung/nodoublets/debris10pc/", scenario_names[i], "/vireo/donor_ids.tsv")
    out <- read_tsv(fn)
  ...
  # Vireo scenarios
  if (i == 1) {
    levels(df_truth_tmp$predicted)[1:6] <- c("T08", "T28", "T31", "T20", "T25", "T09")
  }
...
ggsave("../../../plots/supp_debris/precision_recall_lung_nodoublets_debris10pc.pdf", width = 6.15, height = 3.5)
ggsave("../../../plots/supp_debris/precision_recall_lung_nodoublets_debris10pc.png", width = 6.15, height = 3.5)
