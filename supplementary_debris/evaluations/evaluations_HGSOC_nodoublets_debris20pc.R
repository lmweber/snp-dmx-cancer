...
ggsave("../../../plots/supp_debris/precision_recall_HGSOC_nodoublets_debris20pc.pdf", width = 6.25, height = 3.5)
ggsave("../../../plots/supp_debris/precision_recall_HGSOC_nodoublets_debris20pc.png", width = 6.25, height = 3.5)
