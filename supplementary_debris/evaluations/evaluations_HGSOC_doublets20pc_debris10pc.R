...
ggsave("../../../plots/supp_debris/precision_recall_HGSOC_doublets20pc_debris10pc.pdf", width = 6.25, height = 3.5)
ggsave("../../../plots/supp_debris/precision_recall_HGSOC_doublets20pc_debris10pc.png", width = 6.25, height = 3.5)
