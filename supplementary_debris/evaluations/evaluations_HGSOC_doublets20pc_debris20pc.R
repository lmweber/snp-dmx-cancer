...
ggsave("../../../plots/supp_debris/precision_recall_HGSOC_doublets20pc_debris20pc.pdf", width = 6, height = 3.5)
ggsave("../../../plots/supp_debris/precision_recall_HGSOC_doublets20pc_debris20pc.png", width = 6, height = 3.5)
