...
mkdir -p ../../../supplementary_debris/scenarios/HGSOC/20pc/debris20pc/bulkBcftools_demuxlet
...
--field GT \
--out ../../../supplementary_debris/scenarios/HGSOC/20pc/debris20pc/bulkBcftools_demuxlet/demuxlet
...
# save runtime
mkdir -p ../../../supplementary_debris/scenarios/HGSOC/20pc/debris20pc/bulkBcftools_demuxlet/runtimes
echo runtime: $runtime seconds > ../../../supplementary_debris/scenarios/HGSOC/20pc/debris20pc/bulkBcftools_demuxlet/runtimes/runtime_bulkBcftools_demuxlet_HGSOC_doublets20pc_debris20pc.txt
