...
awk \
-v f_remaining="../../../supplementary_debris/scenarios/lung/30pc/debris_remaining_lung_doublets30pc_debris10pc.tsv" \
-v n_remaining="$(wc -l ../../../supplementary_debris/scenarios/lung/30pc/debris_remaining_lung_doublets30pc_debris10pc.tsv | cut -f1 -d' ')" \
'NR==1 { next } 
...
../../../supplementary_debris/scenarios/lung/30pc/debris_lysed_lung_doublets30pc_debris10pc.tsv ../../../supplementary_debris/scenarios/lung/30pc/debris_remaining_lung_doublets30pc_debris10pc.tsv - | \
samtools view -bo ../../../supplementary_debris/scenarios/lung/30pc/bam_merged_lung_doublets30pc_debris10pc.bam
...
samtools index ../../../supplementary_debris/scenarios/lung/30pc/bam_merged_lung_doublets30pc_debris10pc.bam
...
echo runtime: $runtime seconds > ../../../supplementary_debris/scenarios/lung/30pc/runtime_parse_BAM_lung_doublets30pc_debris10pc.txt
