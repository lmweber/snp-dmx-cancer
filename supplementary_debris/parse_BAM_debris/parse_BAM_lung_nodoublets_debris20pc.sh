...
awk \
-v f_remaining="../../../supplementary_debris/scenarios/lung/nodoublets/debris_remaining_lung_nodoublets_debris20pc.tsv" \
-v n_remaining="$(wc -l ../../../supplementary_debris/scenarios/lung/nodoublets/debris_remaining_lung_nodoublets_debris20pc.tsv | cut -f1 -d' ')" \
'NR==1 { next } 
...
../../../supplementary_debris/scenarios/lung/nodoublets/debris_lysed_lung_nodoublets_debris20pc.tsv ../../../supplementary_debris/scenarios/lung/nodoublets/debris_remaining_lung_nodoublets_debris20pc.tsv - | \
samtools view -bo ../../../supplementary_debris/scenarios/lung/nodoublets/bam_merged_lung_nodoublets_debris20pc.bam
...
samtools index ../../../supplementary_debris/scenarios/lung/nodoublets/bam_merged_lung_nodoublets_debris20pc.bam
...
echo runtime: $runtime seconds > ../../../supplementary_debris/scenarios/lung/nodoublets/runtime_parse_BAM_lung_nodoublets_debris20pc.txt
