...
awk \
'function assign() { cmd = "shuf -n 1 ../../../supplementary_debris/scenarios/HGSOC/20pc/debris_remaining_HGSOC_doublets20pc_debris30pc.tsv"; cmd | getline assigned; close(cmd); return assigned } 
NR==1 { next } FNR==NR { a[$1]=$1; next } (i=gensub(/.*CB\:Z\:([A-Za-z]+\-[A-Za-z0-9]+).*/, "\\1", 1, $0)) in a { gsub(i, assign()) }1' \
../../../supplementary_debris/scenarios/HGSOC/20pc/debris_lysed_HGSOC_doublets20pc_debris30pc.tsv - | \
samtools view -bo ../../../supplementary_debris/scenarios/HGSOC/20pc/bam_merged_HGSOC_doublets20pc_debris30pc.bam
...
samtools index ../../../supplementary_debris/scenarios/HGSOC/20pc/bam_merged_HGSOC_doublets20pc_debris30pc.bam
...
echo runtime: $runtime seconds > ../../../supplementary_debris/scenarios/HGSOC/20pc/runtime_parse_BAM_HGSOC_doublets20pc_debris30pc.txt
