...
awk \
-v f_remaining="../../../supplementary_debris/scenarios/HGSOC/nodoublets/debris_remaining_HGSOC_nodoublets_debris40pc.tsv" \
-v n_remaining="$(wc -l ../../../supplementary_debris/scenarios/HGSOC/nodoublets/debris_remaining_HGSOC_nodoublets_debris40pc.tsv | cut -f1 -d' ')" \
'NR==1 { next } 
...
../../../supplementary_debris/scenarios/HGSOC/nodoublets/debris_lysed_HGSOC_nodoublets_debris40pc.tsv ../../../supplementary_debris/scenarios/HGSOC/nodoublets/debris_remaining_HGSOC_nodoublets_debris40pc.tsv - | \
samtools view -bo ../../../supplementary_debris/scenarios/HGSOC/nodoublets/bam_merged_HGSOC_nodoublets_debris40pc.bam
...
samtools index ../../../supplementary_debris/scenarios/HGSOC/nodoublets/bam_merged_HGSOC_nodoublets_debris40pc.bam
...
echo runtime: $runtime seconds > ../../../supplementary_debris/scenarios/HGSOC/nodoublets/runtime_parse_BAM_HGSOC_nodoublets_debris40pc.txt
