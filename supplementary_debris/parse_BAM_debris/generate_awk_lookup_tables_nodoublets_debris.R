...
f_sim_debris <- function(prop_debris, dataset_name, file_barcodes_merged) {
  ...
  fn_out_lysed <- file.path(
    paste0("../../../supplementary_debris/scenarios/", dataset_name, "/nodoublets"), 
    paste0("debris_lysed_", dataset_name, "_nodoublets_debris", prop_debris * 100, "pc.tsv")
  )
  fn_out_remaining <- file.path(
    paste0("../../../supplementary_debris/scenarios/", dataset_name, "/nodoublets"), 
    paste0("debris_remaining_", dataset_name, "_nodoublets_debris", prop_debris * 100, "pc.tsv")
  )
  ...
  fn_out_barcodes <- file.path(
    paste0("../../../supplementary_debris/scenarios/", dataset_name, "/nodoublets"), 
    paste0("barcodes_merged_", dataset_name, "_nodoublets_debris", prop_debris * 100, "pc.tsv")
  )
