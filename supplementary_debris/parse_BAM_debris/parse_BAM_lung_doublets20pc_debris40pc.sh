...
awk \
-v f_remaining="../../../supplementary_debris/scenarios/lung/20pc/debris_remaining_lung_doublets20pc_debris40pc.tsv" \
-v n_remaining="$(wc -l ../../../supplementary_debris/scenarios/lung/20pc/debris_remaining_lung_doublets20pc_debris40pc.tsv | cut -f1 -d' ')" \
'NR==1 { next } 
...
../../../supplementary_debris/scenarios/lung/20pc/debris_lysed_lung_doublets20pc_debris40pc.tsv ../../../supplementary_debris/scenarios/lung/20pc/debris_remaining_lung_doublets20pc_debris40pc.tsv - | \
samtools view -bo ../../../supplementary_debris/scenarios/lung/20pc/bam_merged_lung_doublets20pc_debris40pc.bam
...
samtools index ../../../supplementary_debris/scenarios/lung/20pc/bam_merged_lung_doublets20pc_debris40pc.bam
...
echo runtime: $runtime seconds > ../../../supplementary_debris/scenarios/lung/20pc/runtime_parse_BAM_lung_doublets20pc_debris40pc.txt
