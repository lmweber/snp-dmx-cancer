...
awk \
-v assigned="$(shuf -n 1 ../../../supplementary_debris/scenarios/HGSOC/20pc/debris_remaining_HGSOC_doublets20pc_debris10pc.tsv)" \
...
samtools index ../../../supplementary_debris/scenarios/HGSOC/20pc/bam_merged_HGSOC_doublets20pc_debris10pc.bam
...
echo runtime: $runtime seconds > ../../../supplementary_debris/scenarios/HGSOC/20pc/runtime_parse_BAM_HGSOC_doublets20pc_debris10pc.txt
