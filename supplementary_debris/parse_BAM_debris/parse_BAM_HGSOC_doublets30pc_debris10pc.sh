...
awk \
-v f_remaining="../../../supplementary_debris/scenarios/HGSOC/30pc/debris_remaining_HGSOC_doublets30pc_debris10pc.tsv" \
-v n_remaining="$(wc -l ../../../supplementary_debris/scenarios/HGSOC/30pc/debris_remaining_HGSOC_doublets30pc_debris10pc.tsv | cut -f1 -d' ')" \
'NR==1 { next } 
...
../../../supplementary_debris/scenarios/HGSOC/30pc/debris_lysed_HGSOC_doublets30pc_debris10pc.tsv ../../../supplementary_debris/scenarios/HGSOC/30pc/debris_remaining_HGSOC_doublets30pc_debris10pc.tsv - | \
