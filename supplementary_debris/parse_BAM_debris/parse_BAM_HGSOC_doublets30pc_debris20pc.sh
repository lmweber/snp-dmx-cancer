...
awk \
-v f_remaining="../../../supplementary_debris/scenarios/HGSOC/30pc/debris_remaining_HGSOC_doublets30pc_debris20pc.tsv" \
-v n_remaining="$(wc -l ../../../supplementary_debris/scenarios/HGSOC/30pc/debris_remaining_HGSOC_doublets30pc_debris20pc.tsv | cut -f1 -d' ')" \
'NR==1 { next } 
...
../../../supplementary_debris/scenarios/HGSOC/30pc/debris_lysed_HGSOC_doublets30pc_debris20pc.tsv ../../../supplementary_debris/scenarios/HGSOC/30pc/debris_remaining_HGSOC_doublets30pc_debris20pc.tsv - | \
samtools view -bo ../../../supplementary_debris/scenarios/HGSOC/30pc/bam_merged_HGSOC_doublets30pc_debris20pc.bam
...
samtools index ../../../supplementary_debris/scenarios/HGSOC/30pc/bam_merged_HGSOC_doublets30pc_debris20pc.bam
...
echo runtime: $runtime seconds > ../../../supplementary_debris/scenarios/HGSOC/30pc/runtime_parse_BAM_HGSOC_doublets30pc_debris20pc.txt
