...
mkdir -p ../../../benchmarking/scenarios/HGSOC/20pc/singlecellCellSNP_cellSNPVireo
...
# save runtime
mkdir -p ../../../benchmarking/scenarios/HGSOC/20pc/singlecellCellSNP_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../benchmarking/scenarios/HGSOC/20pc/singlecellCellSNP_cellSNPVireo/runtimes/runtime_singlecellCellSNP_cellSNPVireo_cellSNP_HGSOC_20pc.txt
...
vireo \
-c ../../../benchmarking/scenarios/HGSOC/20pc/singlecellCellSNP_cellSNPVireo/cellSNP \
-N 3 \
-o ../../../benchmarking/scenarios/HGSOC/20pc/singlecellCellSNP_cellSNPVireo/vireo \
--randSeed=123
...
# save runtime
mkdir -p ../../../benchmarking/scenarios/HGSOC/20pc/singlecellCellSNP_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../benchmarking/scenarios/HGSOC/20pc/singlecellCellSNP_cellSNPVireo/runtimes/runtime_singlecellCellSNP_cellSNPVireo_vireo_HGSOC_20pc.txt
