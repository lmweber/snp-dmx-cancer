...
mkdir -p ../../../benchmarking/scenarios/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo
...
-O ../../../benchmarking/scenarios/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/cellSNP \
...
# save runtime
mkdir -p ../../../benchmarking/scenarios/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../benchmarking/scenarios/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/runtimes/runtime_1000GenomesUnfilt_cellSNPVireo_cellSNP_HGSOC_20pc.txt
...
vireo \
-c ../../../benchmarking/scenarios/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/cellSNP \
-N 3 \
-o ../../../benchmarking/scenarios/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/vireo \
--randSeed=123
...
# save runtime
mkdir -p ../../../benchmarking/scenarios/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../benchmarking/scenarios/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/runtimes/runtime_1000GenomesUnfilt_cellSNPVireo_vireo_HGSOC_20pc.txt
