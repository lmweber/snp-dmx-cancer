...
mkdir -p ../../../benchmarking/scenarios/HGSOC/30pc/bulkBcftools_cellSNPVireo
...
-O ../../../benchmarking/scenarios/HGSOC/30pc/bulkBcftools_cellSNPVireo/cellSNP \
...
# save runtime
mkdir -p ../../../benchmarking/scenarios/HGSOC/30pc/bulkBcftools_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../benchmarking/scenarios/HGSOC/30pc/bulkBcftools_cellSNPVireo/runtimes/runtime_bulkBcftools_cellSNPVireo_cellSNP_HGSOC_30pc.txt
...
vireo \
-c ../../../benchmarking/scenarios/HGSOC/30pc/bulkBcftools_cellSNPVireo/cellSNP \
-N 3 \
-o ../../../benchmarking/scenarios/HGSOC/30pc/bulkBcftools_cellSNPVireo/vireo \
--randSeed=123
...
# save runtime
mkdir -p ../../../benchmarking/scenarios/HGSOC/30pc/bulkBcftools_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../benchmarking/scenarios/HGSOC/30pc/bulkBcftools_cellSNPVireo/runtimes/runtime_bulkBcftools_cellSNPVireo_vireo_HGSOC_30pc.txt
