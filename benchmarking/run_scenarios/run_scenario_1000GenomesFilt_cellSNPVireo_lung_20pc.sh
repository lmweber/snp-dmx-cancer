...
mkdir -p ../../../benchmarking/scenarios/lung/20pc/1000GenomesFilt_cellSNPVireo
...
-O ../../../benchmarking/scenarios/lung/20pc/1000GenomesFilt_cellSNPVireo/cellSNP \
...
# save runtime
mkdir -p ../../../benchmarking/scenarios/lung/20pc/1000GenomesFilt_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../benchmarking/scenarios/lung/20pc/1000GenomesFilt_cellSNPVireo/runtimes/runtime_1000GenomesFilt_cellSNPVireo_cellSNP_lung_20pc.txt
...
vireo \
-c ../../../benchmarking/scenarios/lung/20pc/1000GenomesFilt_cellSNPVireo/cellSNP \
-N 6 \
-o ../../../benchmarking/scenarios/lung/20pc/1000GenomesFilt_cellSNPVireo/vireo \
--randSeed=123
...
# save runtime
mkdir -p ../../../benchmarking/scenarios/lung/20pc/1000GenomesFilt_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../benchmarking/scenarios/lung/20pc/1000GenomesFilt_cellSNPVireo/runtimes/runtime_1000GenomesFilt_cellSNPVireo_vireo_lung_20pc.txt
