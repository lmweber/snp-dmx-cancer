...
mkdir -p ../../../supplementary_snparray/scenarios/HGSOC/20pc/bulkBcftoolsMEGA_demuxlet
...
--field GT \
--out ../../../supplementary_snparray/scenarios/HGSOC/20pc/bulkBcftoolsMEGA_demuxlet/demuxlet
...
# save runtime
mkdir -p ../../../supplementary_snparray/scenarios/HGSOC/20pc/bulkBcftoolsMEGA_demuxlet/runtimes
echo runtime: $runtime seconds > ../../../supplementary_snparray/scenarios/HGSOC/20pc/bulkBcftoolsMEGA_demuxlet/runtimes/runtime_bulkBcftoolsMEGA_demuxlet_cellSNP_HGSOC_20pc.txt
