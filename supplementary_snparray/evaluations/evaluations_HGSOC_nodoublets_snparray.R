...
ggsave("../../../plots/supp_snparray/precision_recall_HGSOC_nodoublets_snparray.pdf", width = 6.7, height = 3.5)
ggsave("../../../plots/supp_snparray/precision_recall_HGSOC_nodoublets_snparray.png", width = 6.7, height = 3.5)
