...
ggsave("../../../plots/supp_snparray/precision_recall_lung_30pc_snparray.pdf", width = 6.5, height = 3.5)
ggsave("../../../plots/supp_snparray/precision_recall_lung_30pc_snparray.png", width = 6.5, height = 3.5)
