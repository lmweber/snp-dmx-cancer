...
../../outputs/lung/doublets/4pc/lookup_table_doublets_lung_4pc.tsv - | \
...
cellSNP \
-s ../../outputs/lung/doublets/4pc/bam_merged_doublets_lung_4pc.bam \
-b ../../outputs/lung/doublets/4pc/barcodes_merged_lung_4pc.tsv \
-O ../../outputs/lung/doublets/4pc/cellSNP \
...
vireo \
-c ../../outputs/lung/doublets/4pc/cellSNP \
-N 6 \
-o ../../outputs/lung/doublets/4pc/vireo \
--randSeed=123
