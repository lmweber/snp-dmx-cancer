...
-O ../../../scenarios/doublets/HGSOC/30pc/1000GenomesFilt_cellSNPVireo/cellSNP \
...
# save runtime
mkdir -p ../../../scenarios/doublets/HGSOC/30pc/1000GenomesFilt_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../scenarios/doublets/HGSOC/30pc/1000GenomesFilt_cellSNPVireo/runtimes/runtime_1000GenomesFilt_cellSNPVireo_cellSNP_HGSOC_30pc.txt
...
# save runtime
mkdir -p ../../../scenarios/doublets/HGSOC/30pc/1000GenomesFilt_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../scenarios/doublets/HGSOC/30pc/1000GenomesFilt_cellSNPVireo/runtimes/runtime_1000GenomesFilt_cellSNPVireo_vireo_HGSOC_30pc.txt
