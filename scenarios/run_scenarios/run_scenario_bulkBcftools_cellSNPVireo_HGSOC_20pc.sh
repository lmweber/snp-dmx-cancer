...
mkdir -p ../../../scenarios/doublets/HGSOC/20pc/bulkBcftools_cellSNPVireo
...
-O ../../../scenarios/doublets/HGSOC/20pc/bulkBcftools_cellSNPVireo/cellSNP \
...
# save runtime
mkdir -p ../../../scenarios/doublets/HGSOC/20pc/bulkBcftools_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../scenarios/doublets/HGSOC/20pc/bulkBcftools_cellSNPVireo/runtimes/runtime_bulkBcftools_cellSNPVireo_cellSNP_HGSOC_20pc.txt
...
vireo \
-c ../../../scenarios/doublets/HGSOC/20pc/bulkBcftools_cellSNPVireo/cellSNP \
-N 3 \
-o ../../../scenarios/doublets/HGSOC/20pc/bulkBcftools_cellSNPVireo/vireo \
--randSeed=123
...
# save runtime
mkdir -p ../../../scenarios/doublets/HGSOC/20pc/bulkBcftools_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../scenarios/doublets/HGSOC/20pc/bulkBcftools_cellSNPVireo/runtimes/runtime_bulkBcftools_cellSNPVireo_vireo_HGSOC_20pc.txt
