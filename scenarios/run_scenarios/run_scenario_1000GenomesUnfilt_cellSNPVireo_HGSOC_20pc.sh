...
mkdir -p ../../../scenarios/doublets/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo
...
-O ../../../scenarios/doublets/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/cellSNP \
...
# save runtime
mkdir -p ../../../scenarios/doublets/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../scenarios/doublets/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/runtimes/runtime_1000GenomesUnfilt_cellSNPVireo_cellSNP_HGSOC_20pc.txt
...
vireo \
-c ../../../scenarios/doublets/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/cellSNP \
-N 3 \
-o ../../../scenarios/doublets/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/vireo \
--randSeed=123
...
# save runtime
mkdir -p ../../../scenarios/doublets/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/runtimes
echo runtime: $runtime seconds > ../../../scenarios/doublets/HGSOC/20pc/1000GenomesUnfilt_cellSNPVireo/runtimes/runtime_1000GenomesUnfilt_cellSNPVireo_vireo_HGSOC_20pc.txt
