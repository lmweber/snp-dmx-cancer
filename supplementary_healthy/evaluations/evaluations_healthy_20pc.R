...
ggsave("../../../plots/supp_healthy/precision_recall_healthy_doublets20pc.pdf", width = 6.15, height = 3.5)
ggsave("../../../plots/supp_healthy/precision_recall_healthy_doublets20pc.png", width = 6.15, height = 3.5)
