...
gunzip -c ../../../scenarios/outputs/HGSOC/16030X3_HJTWLDMXX/outs/filtered_feature_bc_matrix/barcodes.tsv.gz > ../../../genotype/16030X3/barcodes.tsv

cellSNP \
-s ../../../scenarios/outputs/HGSOC/16030X3_HJTWLDMXX/outs/possorted_genome_bam.bam \
...
echo runtime: $runtime seconds > ../../../genotype/runtimes/genotype_singlecell_cellSNP/runtime_genotype_singlecell_cellSNP_16030X3.txt
