...
--outFileNamePrefix ../../bulk/17667X1/STAR/ \
...
samtools index ../../bulk/17667X1/STAR/Aligned.sortedByCoord.out.bam
...
cellSNP \
-s ../../bulk/17667X1/STAR/Aligned.sortedByCoord.out.bam \
-O ../../bulk/17667X1/cellSNP \
-p 20 \
--minMAF=0.01 \
--minCOUNT=10 \
--UMItag=None
