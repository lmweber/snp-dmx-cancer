...
--outFileNamePrefix ../../genotype_bulk/17667X2/STAR/ \
...
samtools index ../../genotype_bulk/17667X2/STAR/Aligned.sortedByCoord.out.bam
...
cellSNP \
-s ../../genotype_bulk/17667X2/STAR/Aligned.sortedByCoord.out.bam \
-O ../../genotype_bulk/17667X2/cellSNP_bulk \
-p 20 \
--minMAF=0.01 \
--minCOUNT=10 \
--UMItag=None
